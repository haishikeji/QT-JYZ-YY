...
import com.px.db.model.service.OrderItemService;
import com.px.db.model.service.OrderReturnItemService;
import com.px.db.model.service.OrderReturnService;
...
public class OrderReturnController extends BaseController {
    ...
    @Authorization(PermissionEnum.orderReturnList)
    ...
    public String listInput(ModelMap map) {
        ...
        for (NavEnum nav : navEnumList) {
            if (nav.getKey().equals("orderReturnExport")) {
                navEnums.add(nav);
            }
        }
        //公共按钮
        ...
        return "order/order_return_list";
    }

    @Authorization(PermissionEnum.orderReturnList)
    @ResponseBody
    @RequestMapping("/list")
    public PageModel list(String orderReturnNo, Integer type, Integer status, Integer orderFrom, Date beginTime, Date endTime, Integer page, Integer limit) {
        //获取门店id
        ...
        List<Map<String, Object>> list = orderReturnListService.storeOrderList(orderReturnNo,type,status,orderFrom,beginTimeStr,endTimeStr,storeId,page,limit);
        Integer count = orderReturnListService.storeOrderCount(orderReturnNo,type,status,orderFrom,beginTimeStr,endTimeStr,storeId);
    ...
    public String viewInput(ModelMap map, Integer id) {
        ...
        map.put("item", item);
        return "order/order_return_detail";
    }
    ...
    public String auditInput(ModelMap map, Integer id) {
        ...
        map.put("item", item);
        return "order/order_return_audit";
    }
    ...
    public String agreeReturnInput(ModelMap map, Integer id) {
        ...
        map.put("item", item);
        return "order/order_return_agree";
    }
     ...
     * @return
     */
    @Authorization(PermissionEnum.orderReturnDel)
    @ResponseBody
    @RequestMapping("/del")
    ...
    @Authorization(PermissionEnum.orderReturnExport)
    ...
    public ResponseResultUtil export(String data, HttpServletResponse response) throws IOException {
        ...
        AdminUser user = LoginUtil.getUserCache(AdminUser.class);
        Integer storeId = user.getStoreId();
        List<Map<String, Object>> orderList = orderReturnListService.storeOrderList(orderReturnNo,type,status,null,beginTime,endTime,storeId,null,null);
